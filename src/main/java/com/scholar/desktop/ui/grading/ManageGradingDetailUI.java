 ...
 * @author mover
 */
public class ManageGradingDetailUI extends javax.swing.JPanel {

    private static final String[] COLUMN_HEADERS = {"ID", "GRADING SCALE", "SYMBOL", "MIN-GRADE", "MAX-GRADE", "STATUS", "DATE CREATED", "AUTHOR"};

    /**
     * Creates new form ManageGradingDetailUI
     */
    private DefaultTableModel tableModel;
    private static ManageGradingDetailUI instance;
    ...
    public ManageGradingDetailUI(SchoolData schoolData) {
    ...
    public static ManageGradingDetailUI getInstance(SchoolData schoolData) {
        if (instance == null) {
            instance = new ManageGradingDetailUI(schoolData);
        }
        return instance;
    }
    ...
    public void populateJTable(List<GradingDetailResponse> list) {
    ...
    public final void fetchData(Integer offset, Integer limit) {
        ...
        SwingWorker swingWorker = new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                list = GradingDetailService.getInstance(schoolData).list(offset, limit);
                populateJTable(list);
                repaint();
                jLabel1.setText("Manage Grading Details");
