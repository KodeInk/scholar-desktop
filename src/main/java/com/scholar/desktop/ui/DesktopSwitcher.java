...
import main.java.com.scholar.desktop.ui.setup.grading.GradingUI;
import main.java.com.scholar.desktop.ui.setup.grading.ManageGradingUI;
...
public class DesktopSwitcher {
    ...
    public void showDashboard(DashboardScreen dashboardScreen, DashboardViews view) {
        ...
        switch (view.toString()) {
            ...
            case "STUDY_PERIOD":
                dashboardScreen.getjSplitPane1().setRightComponent(new ManageStudyYearUI(schoolData));
                break;
