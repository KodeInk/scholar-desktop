...
public class DesktopSwitcher {
    ...
    public void showDashboard(DashboardScreen dashboardScreen, DashboardViews view) {
        ...
        switch (view.toString()) {
            ...
            case "CLASSES":
                dashboardScreen.getjSplitPane1().setRightComponent(ClassesUI.getInstance(schoolData));
                break;
            ...
            case "SUBJECTS":
                dashboardScreen.getjSplitPane1().setRightComponent(SubjectsUI.getInstance(schoolData));
                break;

            case "GRADING":
                dashboardScreen.getjSplitPane1().setRightComponent(GradingUI.getInstance(schoolData));
                break;

            case "STUDY_PERIOD":
                dashboardScreen.getjSplitPane1().setRightComponent(StudyYearUI.getInstance(schoolData));
                break;
